...
public class TwoDimArrayPractice extends JFrame
{
    ...
    // Write your code here:
	   Random ran = new Random( );
	    for ( int row = 0; row < intArray.length; row++ )
	    {
	        ...
	        for ( int column = 0; column < intArray[row].length; column++ )
	        {
	          intArray[row][column] = ran.nextInt( 31 ) + 50;
	          animate( row, column );  
	        }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	    int minimum;
	    minimum = intArray[3][0];
	    for ( int row = 0; row < intArray.length; row++ )
	    {
	        System.out.print( row + "\t" );
	        for ( column = 0; column < intArray.length; column++ )
	        {
	          if(intArray[column][3]<minimum)
	        	  minimum = intArray[column][3];
	          animate( row, column,minimum  );  
	        }
	        System.out.println(intArray);
	    }
   ...
   public int countFound( int value )
   {
    ...
    // Write your code here:
	    ...
	    for ( int row = 0; row < intArray.length; row++ )
	    {
	        ...
	        for ( int column = 0; column < intArray[row].length; column++ )
	        {
	          if(intArray[row][column]==finder)
	        	  keeper++;
	          
	          animate( row, column, finder );  // needed to create visual feedback
	        }
	        System.out.println(intArray);
	    }
